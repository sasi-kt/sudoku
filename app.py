...
def run():
    ...
    return sudoku_board, flat_solved_board

sudoku_board, flat_solved_board = run()
...
@app.route('/refresh')
def refresh():
    global sudoku_board, flat_solved_board
    sudoku_board, flat_solved_board = run()
    return redirect(url_for('index'))  # Redirect to the index route to refresh the page
